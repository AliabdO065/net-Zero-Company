...
class ContactController extends Controller
{
    ...
    public function updatecontact(Request $request)
    {
            $request->validate([
                ...
                'linkedin' => ['required', new DisallowedWords],
            ]);
            $newcontent = 'header=#='.$request->header.'#x#'.'wordheader=#='.$request->wordheader.'#x#'.'phone=#='.$request->phone.'#x#'.
            'facebook=#='.$request->facebook.'#x#'.'twitter=#='.$request->twitter.'#x#'.'youtube=#='.$request->youtube.'#x#'.
            'instagram=#='.$request->instagram.'#x#'.'linkedin=#='.$request->linkedin;
