...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function updatecontrol(Request $request)
    {
            $request->validate([
                ...
                'projects' => ['required', new DisallowedWords],
                'descprojects' => ['required', new DisallowedWords],
                'news' => ['required', new DisallowedWords],
                'descnews' => ['required', new DisallowedWords],
                'insights' => ['required', new DisallowedWords],
                'descinsights' => ['required', new DisallowedWords],
            ]);
            $newcontent = 'headerprojects=#='.$request->headerprojects.'#x#'.'wordheaderprojects=#='.$request->wordheaderprojects.'#x#'
                        ...
                        .'#x#'.'projects=#='.$request->projects.'#x#'.'descprojects=#='.$request->descprojects
                        .'#x#'.'news=#='.$request->news.'#x#'.'descnews=#='.$request->descnews
                        .'#x#'.'insights=#='.$request->insights.'#x#'.'descinsights=#='.$request->descinsights;
...
////
    public function storefooter(Request $request)
    {
        $request->validate([
            ...
            'status' => ['required', new DisallowedWords],
            'googleMaps' => ['required', new DisallowedWords],
        ]);

        $contentAsString = $this->getContent(9);
        $content = explode("#xt#",$contentAsString);
        if (!empty($content[0]))
            $str = '#xt#'.'name=#='.$request->name.'#x#'.'phone=#='.$request->phone.'#x#'.'email=#='.$request->email.'#x#'.'address=#='.$request->address.'#x#'.'status=#='.$request->status.'#x#'.'googleMaps=#='.$request->googleMaps;
        else 
            $str ='name=#='.$request->name.'#x#'.'phone=#='.$request->phone.'#x#'.'email=#='.$request->email.'#x#'.'address=#='.$request->address.'#x#'.'status=#='.$request->status.'#x#'.'googleMaps=#='.$request->googleMaps;
        $newcontent = $contentAsString . $str;
        $slidesarr['content'] = $newcontent;
...
////
    public function editfooter($id)
    {
        ...
        if($id>0)
            $old= '#xt#'.'name=#='.$slide['name'].'#x#'.'phone=#='.$slide['phone'].'#x#'.'email=#='.$slide['email'].'#x#'.'address=#='.$slide['address'].'#x#'.'status=#='.$slide['status'].'#x#'.'googleMaps=#='.$slide['googleMaps'];
        else
            $old= 'name=#='.$slide['name'].'#x#'.'phone=#='.$slide['phone'].'#x#'.'email=#='.$slide['email'].'#x#'.'address=#='.$slide['address'].'#x#'.'status=#='.$slide['status'].'#x#'.'googleMaps=#='.$slide['googleMaps'];
...
////
    public function deletefooter($id)
    {
        ...
        $old= 'name=#='.$slide['name'].'#x#'.'phone=#='.$slide['phone'].'#x#'.'email=#='.$slide['email'].'#x#'.'address=#='.$slide['address'].'#x#'.'status=#='.$slide['status'].'#x#'.'googleMaps=#='.$slide['googleMaps'].'#xt#';
        else
        $old= 'name=#='.$slide['name'].'#x#'.'phone=#='.$slide['phone'].'#x#'.'email=#='.$slide['email'].'#x#'.'address=#='.$slide['address'].'#x#'.'status=#='.$slide['status'].'#x#'.'googleMaps=#='.$slide['googleMaps'];
        $newcontent = str_replace($old,'' ,$allcontent);
        Home::find(9)->update(['content' => $newcontent]);
