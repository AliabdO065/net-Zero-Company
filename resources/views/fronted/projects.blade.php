...
<link rel="alternate" type="application/json" href="{{asset('fronted/wp-json/wp/v2/pages/1002.json')}}" />
...
<link rel="canonical" href="{{route('fronted.projects')}}" />
<link rel='shortlink' href='{{asset('fronted/index50b4.html?p=1002')}}' />
<link rel="alternate" type="application/json+oembed" href="{{asset('fronted/wp-json/oembed/1.0/embed042e.json?url=https:%2F%2Fthemes.pixelwars.org%2Fenergify%2Fdemo-01%2Fprojects%2F')}}" />
<link rel="alternate" type="text/xml+oembed" href="{{asset('fronted/wp-json/oembed/1.0/embeda7ff?url=https:%2F%2Fthemes.pixelwars.org%2Fenergify%2Fdemo-01%2Fprojects%2F&amp;format=xml')}}" />
...
<body class="page-template page-template-page_template-portfolio page-template-page_template-portfolio-php page page-id-1002 qodef-qi--no-touch qi-addons-for-elementor-1.6.5 elementor-default elementor-kit-8">
...
<li id="menu-item-1729" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1002 current_page_item menu-item-1729"><a href="{{route('fronted.projects')}}" aria-current="page">Projects</a></li>
...
<div id="main" class="site-main">
	<div class="layout-medium">
		<div id="primary" class="content-area ">
			...
			<img width="550" height="362" src="{{asset($slide['img'])}}" class="attachment-energify_image_size_4 size-energify_image_size_4 wp-post-image" alt="" decoding="async" loading="lazy" />									</a>
																</div> <!-- .featured-image -->
			...
			{{$slide['name']}}									</a>
											...
											<span class="portfolio-excerpt">
												{{$slide['category']}}																		</span> <!-- .portfolio-excerpt -->
										</div> <!-- .entry-meta -->
																						</header> <!-- .entry-header -->
					</div> <!-- .hentry-middle -->
				</div> <!-- .hentry-wrap -->
