                    ...
                    <div id="content" class="site-content" role="main">
                        <div class="post-header post-header-classic archive-header">
							...
							<span class="cat-title">
                                ...
                                @if ($word == 'INSIGHTS')
							{{$control['insights']}}
                            <p style="display: block;font-size:27px">{{$control['descinsights']}}</p>                     </h1> <!-- .entry-title -->						</h1> <!-- .entry-title -->
                                @else
							{{$control['news']}}
                            <p style="display: block;font-size:27px">{{$control['descnews']}}</p>                     </h1> <!-- .entry-title -->
                                @endif
