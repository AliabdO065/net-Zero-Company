...
<link rel='stylesheet' id='elementor-post-3178-css' href='{{asset('fronted/wp-content/uploads/sites/2/elementor/css/post-3178713b.css?ver=1699620558')}}' type='text/css' media='all' />
...
<link rel="alternate" type="application/json" href="{{asset('fronted/wp-json/wp/v2/portfolio/3178.json')}}" />
...
{{-- <link rel="canonical" href="{{route('fronted.projectDetails',$i)}}" /> --}}
<link rel='shortlink' href='{{asset('fronted.index8372.html?p=3178')}}' />
<link rel="alternate" type="application/json+oembed" href="{{asset('fronted/wp-json/oembed/1.0/embed6137.json?url=https%3A%2F%2Fthemes.pixelwars.org%2Fenergify%2Fdemo-01%2Fportfolio%2Fsolarglow-initiative%2F')}}" />
<link rel="alternate" type="text/xml+oembed" href="{{asset('fronted/wp-json/oembed/1.0/embed7951?url=https%3A%2F%2Fthemes.pixelwars.org%2Fenergify%2Fdemo-01%2Fportfolio%2Fsolarglow-initiative%2F&amp;format=xml')}}" />
...
<body class="portfolio-template portfolio-template-elementor_header_footer single single-portfolio postid-3178 single-format-standard qodef-qi--no-touch qi-addons-for-elementor-1.6.5 elementor-default elementor-template-full-width elementor-kit-8 elementor-page elementor-page-3178">
...
<li id="menu-item-1000" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1000"><a href="{{route('fronted.contact')}}">Contact</a></li>
        ...
        </header> <!-- #masthead .site-header -->		<div data-elementor-type="wp-post" data-elementor-id="3178" class="elementor elementor-3178">
			...
			<div class="qodef-shortcode qodef-m  qodef-qi-animated-text qodef--animated-by-letter qodef--alignment-left qodef-qi--has-appear qodef--appear-from-right" >
				<h1 class="qodef-m-title">
					@if ($item != '')
						<?php
					$header = explode(' ', $item['name'] );
					?>
					@foreach ($header as $iw)
					<span class="qodef-e-word-holder">{{$iw}}</span>
					@endforeach
					@else 
...
<li>
	...
	<p>
		{{$item['wordtitle']}}		</p></div>
<div class="qodef-tabs-horizontal-content" id="qodef-tab-0927390">
	<p>{{$item['contentsubtitle1']}}</p></div>
<div class="qodef-tabs-horizontal-content" id="qodef-tab-b0d90cc">
	<div class="flex-1 overflow-hidden"><div class="react-scroll-to-bottom--css-aitrd-79elbk h-full dark:bg-gray-800">
		<div class="react-scroll-to-bottom--css-aitrd-1n7m0yu">
			{{$item['contentsubtitle2']}}			.</div><div>
				{{$item['contentsubtitle3']}}				</div></div></div><div class="absolute bottom-0 left-0 w-full border-t md:border-t-0 dark:border-white/20 md:border-transparent md:dark:border-transparent md:bg-vert-light-gradient bg-white dark:bg-gray-800 md:!bg-transparent dark:md:bg-vert-dark-gradient pt-2"><div class="relative flex h-full flex-1 items-stretch md:flex-col"><div class=""><div class="h-full flex ml-1 md:w-full md:m-auto md:mb-2 gap-0 md:gap-2 justify-center"> </div></div></div></div></div>
</div>
		</div>
				</div>
					</div>
			...
			<div class="qodef-shortcode qodef-m  qodef-qi-animated-text qodef--animated-by-letter qodef--alignment-left qodef-qi--has-appear qodef--appear-from-right" >
				...
				<h1 class="qodef-m-title">
					<?php
					$header = explode(' ', $item['subheader1'] );
					?>
					@foreach ($header as $iw)
					<span class="qodef-e-word-holder">{{$iw}}</span>
					@endforeach	
...
{{$item['contentsubheader1']}}	</p>						</div>
	...
	<div class="qodef-m-images">
		<div class="qodef-e-main-image-holder">
			<div class="qodef-e-main-image-zoom-holder">
						...
						<img width="1300" height="1282" src="{{asset($item['bimg1'])}}"
						 class="attachment-qi_addons_for_elementor_image_size_huge-square size-qi_addons_for_elementor_image_size_huge-square" alt=""
			...
			<div class="qodef-shortcode qodef-m  qodef-qi-animated-text qodef--animated-by-letter qodef--alignment-left qodef-qi--has-appear qodef--appear-from-right" >
				<h1 class="qodef-m-title">
					<?php
					$header = explode(' ', $item['subheader2'] );
					?>
					@foreach ($header as $iw)
					<span class="qodef-e-word-holder">{{$iw}}</span>
					@endforeach	
	...
	<div class="qodef-m-images">
		<div class="qodef-e-main-image-holder">
			<div class="qodef-e-main-image-zoom-holder">
									<div class="qodef-e-main-image" data-parallax-main="45">
						<img width="1920" height="1280" src="{{asset($item['bimg2'])}}" class="attachment-full size-full" alt="" decoding="async" 
						loading="lazy" srcset="{{asset($item['bimg2'])}} 1920w,{{asset($item['bimg2'])}} 300w, {{asset($item['bimg2'])}} 768w, 
						{{asset($item['bimg2'])}} 825w, {{asset($item['bimg2'])}} 1620w", sizes="(max-width: 1920px) 100vw, 1920px" />					</div>
							</div>
		</div>
													<div class="qodef-e-parallax-image qodef-position--bottom-left elementor-repeater-item-9c4ad66" >
									</div>
		...
		<span class="qodef-m-icon-inner">
            ...
            <div class="bdt-prime-slider-skin-coral">
                <div class="bdt-position-relative bdt-visible-toggle" data-settings="{&quot;id&quot;:&quot;#bdt-fcc892e&quot;,&quot;animation_status&quot;:&quot;no&quot;}" id="bdt-fcc892e" bdt-slideshow="{&quot;animation&quot;:&quot;fade&quot;,&quot;ratio&quot;:false,&quot;min-height&quot;:false,&quot;autoplay&quot;:true,&quot;autoplay-interval&quot;:7000,&quot;pause-on-hover&quot;:false,&quot;velocity&quot;:1,&quot;finite&quot;:false}">
                    <ul class="bdt-slideshow-items" style="min-height:60vh">
        

						@if ( !empty($projects[0]))

						@foreach ($projects as $i => $slides)
      ...
      <div class="bdt-slideshow-content-wrapper">
        <div class="bdt-prime-slider-wrapper">
          <div class="bdt-prime-slider-content">
            ...
            <a class="bdt-slide-btn" href="{{route('fronted.projectDetails',$i)}}">

                
                <span class="bdt-prime-slider-button-wrapper">
                    <span class="bdt-prime-slider-button-text bdt-flex bdt-flex-middle bdt-flex-inline">view project<span class="bdt-slide-btn-icon">
	...
	@endif
      ...
      <div class="bdt-ps-thumbnav reveal-muted">
		...
		?>	
            ...
            <li class="bdt-slide-counter" bdt-slideshow-item="{{$i}}"
                data-label="{{count($projects) - 1}}">
...
<li bdt-slideshow-item="{{$i}}"
data-label="{{$i}}"><a
  href="{{route('fronted.projectDetails',$i)}}">{{$i}}</a>
...
<span>{{count($projects)}}</span>
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<a class="qodef-shortcode qodef-m  qodef-qi-button qodef-html--link qodef-layout--textual    qodef-icon--right qodef-hover--icon-move-horizontal-short   qodef-text-underline qodef-underline--left " href="../../contact/index.html" target="_self">
	...
	<h1 class="qodef-m-text">
		...
		{{$contact['wordtitle']}}					<span class="qodef-typeout-holder">
			<span class="qodef-typeout"></span>
				...
				<div class="elementor-widget-container">
			<a class="qodef-shortcode qodef-m  qodef-qi-button qodef-html--link qodef-layout--outlined qodef-type--icon-boxed   qodef-icon--right qodef-hover--icon-move-horizontal-short   qodef-text-underline qodef-underline--left " href="../../contact/index.html" target="_self">
	<span class="qodef-m-text">Let&#039;s Talk</span>
		...
		<span class="qodef-m-icon-inner">
			<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="7px" height="7px" viewBox="1.25 1.25 7 7" xml:space="preserve"><polygon fill="#ffffff" points="1.25,1.25 1.25,2.25 6.543,2.25 1.25,7.543 1.958,8.25 7.25,2.957 7.25,8.25 8.25,8.25 8.25,1.25 8.25,1.25 "></polygon></svg>					</span>
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-042703b elementor-section-stretched elementor-section-height-min-height elementor-section-items-top elementor-section-boxed elementor-section-height-default" data-id="042703b" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;stretch_section&quot;:&quot;section-stretched&quot;}">
							<div class="elementor-background-overlay"></div>
							<div class="elementor-container elementor-column-gap-default">
								...
								<div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-017bae4" data-id="017bae4" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-563acbd elementor-widget elementor-widget-heading" data-id="563acbd" data-element_type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
			<h5 class="elementor-heading-title elementor-size-default">{{$slide['name']}} </h5>		</div>
				</div>
				<div class="elementor-element elementor-element-6e0f830 elementor-align-left elementor-mobile-align-left elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="6e0f830" data-element_type="widget" data-widget_type="icon-list.default">
				<div class="elementor-widget-container">
			<link rel="stylesheet" href="{{asset('fronted/wp-content/plugins/elementor/assets/css/widget-icon-list.min.css')}}">		<ul class="elementor-icon-list-items">
				...
				<div class="elementor-element elementor-element-ebabfb0 elementor-align-left elementor-mobile-align-left elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="ebabfb0" data-element_type="widget" data-widget_type="icon-list.default">
				<div class="elementor-widget-container">
