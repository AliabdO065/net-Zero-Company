...
<div class="wrapper">
    ...
    <div class="page">
        ...
        <div class="page-inner">
            <form action="{{route('dashboard.about.services.updateHeader')}}" method="POST">
                @csrf
                @method('POST')
                <?php 
                        $string = $header;
            ...
            <hr><a href="{{route('dashboard.about.services.add')}}" type="button" class="btn btn-success">Add Slide</a> <hr>
